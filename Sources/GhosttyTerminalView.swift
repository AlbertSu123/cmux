    ...
    private func handleAction(target: ghostty_target_s, action: ghostty_action_s) -> Bool {
        ...
        case GHOSTTY_ACTION_OPEN_URL:
            ...
            return performOnMain {
                ...
                // Fetch it over scp and preview the local copy.
                return surfaceView.tryOpenRemoteLinkToken(
    ...
    private func handleCommandClickRelease(
        ...
        let route = commandClickReleaseRouter.route(
            ...
            return TerminalCommandClickReleaseRouter.ResolvedPath(
                ...
                opensInCmux: CommandClickFileOpenRouter.shouldRouteInCmux(path: resolution.path)
            )
        }
